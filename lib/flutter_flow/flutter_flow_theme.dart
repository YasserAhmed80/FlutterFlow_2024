...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFFC0CB);
  late Color tertiary = const Color(0xFF87CEEB);
  late Color alternate = const Color(0xFF20B2AA);
  ...
  late Color accent4 = const Color(0xFF800080);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFF69B4);
  late Color tertiary = const Color(0xFF4682B4);
  late Color alternate = const Color(0xFF008B8B);
